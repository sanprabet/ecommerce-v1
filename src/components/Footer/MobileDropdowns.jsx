...
export function MobileFooterDropDownMenu({title, terms}) {
...
export function MobileFooterDropDownLinkMenu({title, terms}) {
    const[menuOpened, setMenuOpened] = useState(false);
...
export default MobileFooterDropDownLinkMenu