...
const opinions = [
  ...
  {id:2, text: "Llevamos 4 años trabajando juntos y nuestra experiencia de autocultivo para uso medicinal ha sido maravillosa con su asesoria.", author_name:"Luis Ramirez", author_pic: PictureGuy2},
  {id:3, text: "Estoy muy felix con mis compras, todas llegaron a tiempo hasta mi casa en Medellin. Armario listo y la jugueteria la estoy disfrutando.", author_name:"Camila Gonzales", author_pic: PictureGirl},
  {id:4, text: "El sistema de luces que me instalaron quedo perfecto. Voy para la segunda cosecha, y esos sistemas Floraflex dan un rendimiento sorprendente.", author_name:"Juan C. Arias", author_pic: PictureGuy},
  {id:5, text: "Llevamos 4 años trabajando juntos y nuestra experiencia de autocultivo para uso medicinal ha sido maravillosa con su asesoria.", author_name:"Luis Ramirez", author_pic: PictureGuy2},
]
